...
When exposing Fider to the internet, it's strongly recommended to setup HTTPS. Take a look at [How to enable TLS/SSL](/guides/how-to-enable-ssl) to learn multiple ways on how to do that.
